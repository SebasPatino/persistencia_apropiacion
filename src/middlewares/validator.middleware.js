 ...
 * Middleware GENÉRICO y REUTILIZABLE de validación con Zod.
 *
 * En lugar de crear un middleware por recurso, este único middleware
 * recibe cualquier esquema Zod y lo aplica dinámicamente.
 *
 * Uso en rutas:
